...
<div class="title_left">
    ...
    <div class="clearfix"></div>               
                        ...
                        <form action="customerStore2" class="form-horizontal form-label-left" methode="POST" >
                          {{ csrf_field() }}
...
<script type="text/javascript">
                                jQuery(document).ready(function ()
                                {
                                        jQuery('select[name="provinsi"]').on('change',function(){
                                           ...
                                           {
                                              jQuery.ajax({
                                                 url : '../customer/create2/getstates/' +countryID,
                                                 type : "GET",
                                                 dataType : "json",
                                ...
                                jQuery(document).ready(function ()
                                {
                                        jQuery('select[name="kota"]').on('change',function(){
                                           ...
                                           {
                                              jQuery.ajax({
                                                 url : '../customer/create2/kecamatan/' +id_kota,
                                                 type : "GET",
                                                 dataType : "json",
                                                 success:function(data)
                                                 {
                                ...
                                jQuery(document).ready(function ()
                                {
                                        jQuery('select[name="kecamatan"]').on('change',function(){
                                           ...
                                           {
                                              jQuery.ajax({
                                                 url : '../customer/create2/kelurahan/' +id_kec,
                                                 type : "GET",
                                                 dataType : "json",
                                                 success:function(data)
                                                 {
